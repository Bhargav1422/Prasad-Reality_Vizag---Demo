# streamlit_app.py (Enhanced + Instagram authenticity)
...
<style>
  ...
  .brand-header {{ background: linear-gradient(90deg, {BRAND_PRIMARY} 0%, {BRAND_DARK} 100%); color: white; padding: 24px 28px; border-radius: 14px; margin-bottom: 18px; }}
  .brand-header h1 {{ margin: 0; font-size: 32px; }}
  .brand-header p {{ margin: 6px 0 0 0; opacity: 0.9; }}
  .property-card {{ background: white; border-radius: 16px; box-shadow: 0 4px 18px rgba(0,0,0,0.08); overflow: hidden; margin-bottom: 16px; border: 1px solid #e9eef2; }}
  .card-image {{ width: 100%; height: 180px; object-fit: cover; display: block; }}
  .card-body {{ padding: 16px 18px; }}
  .badges {{ display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 8px; }}
  .badge {{ display: inline-block; padding: 6px 10px; border-radius: 999px; font-size: 12px; font-weight: 600; background: #edf2f7; color: #2d3748; border: 1px solid #e2e8f0; }}
  ...
  .link-btn {{ padding: 8px 12px; border-radius: 10px; text-decoration: none; background: #f1f5f9; color: #0f172a; font-weight: 600; border: 1px solid #e2e8f0; display: inline-block; }}
...
# ---------------------------------
# Authentic listings from Instagram content (mocked)
# ---------------------------------
BASE_PROPERTIES = [
    # Original demos
    {"id":"VRV-001","title":"Premium 3BHK Apartment — Sea View","locality":"MVP Colony","condition":"New","property_type":"Apartment","price_lakhs":120.0,"size_sqft":1600,"bed":3,"bath":3,"lat":17.7489,"lon":83.3365,"img":"https://images.unsplash.com/photo-1505693416383-83d887b81a56?w=1200","desc":"Modern tower apartment with panoramic Bay of Bengal views, close to schools & parks.","tags":["New Listing","Premium","Best for Families"],"is_premium":True,"is_new_listing":True,"family_friendly":True},
    {"id":"VRV-002","title":"Cozy 2BHK Individual House","locality":"Visalakshinagar","condition":"Old","property_type":"Individual House","price_lakhs":72.5,"size_sqft":1100,"bed":2,"bath":2,"lat":17.7635,"lon":83.3482,"img":"https://images.unsplash.com/photo-1560185127-6a93464c7f5a?w=1200","desc":"Quiet lane, independent home with a small garden. Ideal for couples or small families.","tags":["Budget-Friendly","Calm Neighbourhood"],"is_premium":False,"is_new_listing":False,"family_friendly":True},
    {"id":"VRV-003","title":"Elegant 4BHK Apartment — City Skyline","locality":"Hanumanthawaka","condition":"New","property_type":"Apartment","price_lakhs":145.0,"size_sqft":1900,"bed":4,"bath":4,"lat":17.7410,"lon":83.3166,"img":"https://images.unsplash.com/photo-1617104125948-c2ca1964b4a2?w=1200","desc":"Premium tower apartment near transit hubs. Spacious, bright, and well-ventilated.","tags":["Premium","New Listing"],"is_premium":True,"is_new_listing":True,"family_friendly":True},
    {"id":"VRV-004","title":"3BHK Individual House — Corner Plot","locality":"MVP Colony","condition":"Old","property_type":"Individual House","price_lakhs":98.0,"size_sqft":1500,"bed":3,"bath":3,"lat":17.7441,"lon":83.3350,"img":"https://images.unsplash.com/photo-1600585154082-9d410a0fb096?w=1200","desc":"Corner home with ample sunlight and parking. Easy access to main roads.","tags":["Best for Families","Parking"],"is_premium":False,"is_new_listing":False,"family_friendly":True},
    {"id":"VRV-005","title":"Smart 2BHK Apartment — Move-in Ready","locality":"Visalakshinagar","condition":"New","property_type":"Apartment","price_lakhs":85.0,"size_sqft":1200,"bed":2,"bath":2,"lat":17.7590,"lon":83.3500,"img":"https://images.unsplash.com/photo-1519710164239-da123dc03ef4?w=1200","desc":"Fresh interiors, great ventilation, and close to the beach. Ideal starter home.","tags":["New Listing","Starter Home"],"is_premium":False,"is_new_listing":True,"family_friendly":True},
    {"id":"VRV-006","title":"Spacious 5BHK Individual House — Quiet Street","locality":"Hanumanthawaka","condition":"Old","property_type":"Individual House","price_lakhs":165.0,"size_sqft":2400,"bed":5,"bath":4,"lat":17.7389,"lon":83.3149,"img":"https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=1200","desc":"Large family home with ample storage, balconies, and backyard space.","tags":["Premium","Best for Families"],"is_premium":True,"is_new_listing":False,"family_friendly":True},

    # Authentic Instagram-based entries (from your captions)
    {"id":"VRV-007","title":"2BHK Flat — Sai Santhoshi Residence (2nd Floor)","locality":"Chinnamushidiwada","condition":"New","property_type":"Apartment","price_lakhs":0.0,"size_sqft":850,"bed":2,"bath":2,"lat":17.7780,"lon":83.2350,"img":"https://images.unsplash.com/photo-1507089943778-0d63b1f95b42?w=1200","desc":"Group House near Indira Gandhi Park & Saradapeetam. Car parking available. Each floor has 2 flats.","tags":["Best for Families","Excellent Connectivity"],"is_premium":False,"is_new_listing":True,"family_friendly":True},
    {"id":"VRV-008","title":"Commercial Property — Prime Maddilapalem (1200 Sq. Yards)","locality":"Maddilapalem","condition":"New","property_type":"Commercial","price_lakhs":0.0,"size_sqft":10800,"bed":0,"bath":0,"lat":17.7365,"lon":83.3219,"img":"https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=1200","desc":"Ideal for showrooms, offices, complexes. High visibility & excellent connectivity in Vizag’s busiest zone.","tags":["Investment Opportunity","High Visibility"],"is_premium":True,"is_new_listing":True,"family_friendly":False},
    {"id":"VRV-009","title":"Premium 3BHK — Seethammadhara (2050 sqft, 3rd Floor)","locality":"Seethammadhara","condition":"New","property_type":"Apartment","price_lakhs":205.0,"size_sqft":2050,"bed":3,"bath":3,"lat":17.7449,"lon":83.3120,"img":"https://images.unsplash.com/photo-1582582429416-d1e9b7a8479f?w=1200","desc":"One flat per floor. False ceiling & quality woodwork. Balcony & corridor. CCTV, power backup, Johnson lift. 100% Vastu.","tags":["Premium","Vastu","New Listing"],"is_premium":True,"is_new_listing":True,"family_friendly":True},
    {"id":"VRV-010","title":"Open Plot — Borapeta, Bheemili (567 Sq. Yards)","locality":"Bheemili","condition":"New","property_type":"Plot","price_lakhs":113.4,"size_sqft":5103,"bed":0,"bath":0,"lat":17.9050,"lon":83.4520,"img":"https://images.unsplash.com/photo-1523419409543-a4c7457fb928?w=1200","desc":"South-facing 60×85 opposite Ramki Vacation Resorts Gate Road. Peaceful location for investment or your dream home.","tags":["Investment","Peaceful"],"is_premium":False,"is_new_listing":True,"family_friendly":True}
]
...
if "analytics" not in st.session_state:
    st.session_state.analytics = {
        'locality_counts': {}, 'condition_counts': {}, 'type_counts': {}, 'search_terms': {}, 'sort_counts': {}
    }
if "prev_filters" not in st.session_state:
    st.session_state.prev_filters = {'localities': None, 'condition': None, 'type': None, 'search': None, 'sort': None}
...
sort_by = st.sidebar.selectbox("Sort by", ["Price (low → high)", "Price (high → low)", "Size (small → large)", "Size (large → small)", "Newest Listings"], index=0)

# Analytics update on change
        ...
        if submitted:
            if not new_id or not new_title:
                ...
                st.session_state.properties.append({
                    "id": new_id, "title": new_title, "locality": new_locality,
                    "condition": new_condition, "property_type": new_type,
                    "price_lakhs": float(new_price), "size_sqft": int(new_size),
                    "bed": int(new_bed), "bath": int(new_bath),
                    "lat": float(new_lat), "lon": float(new_lon), "img": new_img,
                    "desc": new_desc, "tags": [t for t,f in [("Premium",is_premium),("New Listing",is_new_list),("Best for Families",family_ok)] if f],
                    "is_premium": bool(is_premium), "is_new_listing": bool(is_new_list), "family_friendly": bool(family_ok)
                })
...
if show_map and filtered_props:
    ...
    heat_layer = pdk.Layer('HeatmapLayer', data=df_map, get_position='[longitude, latitude]', aggregation='MEAN', get_weight=1, radiusPixels=40)
...
def render_property_card(prop):
    # Compute price display (show only if available)
    price_val = prop.get("price_lakhs")
    price_html = ""
    if price_val and price_val > 0:
        price_html = f"₹{price_val:.1f} Lakhs"
        # If we have size, show price per sqft for Apartments/Individual House
    ...
    msg = f"Hello Prasad Reality Vizag, I'm interested in {prop['title']} ({prop['id']}) in {prop['locality']}. Is it available?"
    ...
    with c2:
        st.download_button(label="⬇️ Download info", data=pd.Series(prop).to_json(indent=2), file_name=f"{prop['id']}.json", mime="application/json", key=f"dl_{prop['id']}")
...
if st.session_state.shortlist:
    ...
    st.download_button("⬇️ Download shortlist (CSV)", data=df_short.to_csv(index=False), file_name=f"shortlist_{datetime.now().strftime('%Y%m%d_%H%M')}.csv", mime="text/csv")
    # WhatsApp export of shortlist
    lines = [f"{p['id']} | {p['title']} | {p['locality']} | ₹{int(p['price_lakhs'])} Lakhs | {p['size_sqft']} sqft" for p in st.session_state.shortlist]
    ...
    if submitted:
        if not name or not phone:
            ...
            st.session_state.leads.append({
                'timestamp': datetime.now().strftime('%Y-%m-%d %H:%M'), 'name': name, 'phone': phone,
                'email': email, 'preferred_locality': pref_loc, 'preferred_type': pref_type,
...
if st.session_state.leads:
    ...
    st.download_button("⬇️ Download leads (CSV)", data=df_leads.to_csv(index=False), file_name=f"leads_{datetime.now().strftime('%Y%m%d_%H%M')}.csv", mime="text/csv")
else:
